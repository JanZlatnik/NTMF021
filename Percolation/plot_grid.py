...
bound_sw_file = 'boundary_SW.txt' 
bound_ne_file = 'boundary_NE.txt' 
...
bound_sw = np.loadtxt(bound_sw_file)
bound_ne = np.loadtxt(bound_ne_file)
...
ax.scatter(bound_sw[:, 0], bound_sw[:, 1], s=10, c='red', marker='o', zorder=10)
ax.scatter(bound_ne[:, 0], bound_ne[:, 1], s=10, c='blue', marker='o', zorder=10)


ax.set_title(r"Penrose Tiling Grid with Boundary Nodes")
ax.set_xlabel(r"$x$")
ax.set_ylabel(r"$y$")
ax.set_aspect('equal') 
ax.autoscale_view()   
